...
class News(Base):
    ...
    external_id: Mapped[Optional[str]] = mapped_column(String(120), comment="外部条目ID")
    ...
    source_score: Mapped[int] = mapped_column(Integer, default=0, nullable=False, comment="来源原生热度")
    source_comment_count: Mapped[int] = mapped_column(Integer, default=0, nullable=False, comment="来源原生评论数")
